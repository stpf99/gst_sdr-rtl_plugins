...
# Szczyt wezszy niz tyle sasiednich binow ponad progiem jest uznawany za
...
class SdrWindow(Adw.ApplicationWindow):
    ...
    def _find_peak(self, mag_c, center, bin_hz):
        ...
        # v6 FIX: pojedynczy bin (lub 2) ponad progiem to zazwyczaj szum,
        # nie realny sygnal - odrzucamy go, zeby nie trafil do bufora
        # auto-korekty (to on powodowal "klik" przy skokach - patrz naglowek
        # pliku). Ten sam warunek uzywa find_validated_peaks() dla widma
        # w zakladce Stacje.
    ...
    def _update_station_info(self):
        ...
        # a ta metoda jest wywoływana już przy budowie "Stacje".
